...
if __name__ == '__main__':
    ...
    # print(poi)
    poi = range(min(listoflens)-1 - (numlags-1)*lagsize)
    ...
    LorenzCallSamePts(Similarity.maxNeighborDistMean,'mean max neighbor dist',os.path.expanduser('~/temp/LorenzMaxNeighborDistMean'),callmesameptsscalar)
