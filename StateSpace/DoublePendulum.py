...
if __name__ == '__main__':
    ...
    SSRPlots.plotManifold(x[:,(0,1)],show=0,titlestr='x, y',style='b-')
    # SSRPlots.plotManifold(x[:,(0,1,2)],show=1,titlestr='x, y, z',style='r-')
    SSRPlots.plotShadowManifold(x[:,0],3,100,show=0,hold=0,style='r-',titlestr=r'$M_x$')
    SSRPlots.plotShadowManifold(x[:,1],3,100,show=0,hold=0,style='g-',titlestr=r'$M_y$')
    SSRPlots.plotShadowManifold(x[:,2],3,115,show=0,hold=0,style='m-',titlestr=r'$M_z$')
    SSRPlots.plotShadowManifold(x[:,3],3,100,show=1,hold=0,style='k-',titlestr=r'$M_w$')
