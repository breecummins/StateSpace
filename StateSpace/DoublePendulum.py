...
if __name__ == '__main__':
    ...
    SSRPlots.plotShadowManifold(x[:len(x)/2,3],numlags,lagsize,show=0,hold=0,style='b-')
    SSRPlots.plotShadowManifold(x[:len(x)/1,3],numlags,lagsize,show=1,hold=0,style='g-')
