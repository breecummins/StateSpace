...
def nononlinearDiamondTS(finaltime=1200.0,dt=0.025,d=0.05):
...
def runDiamond(finaltime=1200.0,remote=1,unrotated=0,nononlinear=1):
    ...
    if unrotated:
        ...
        eqns,names,ts = nononlinearDiamondTS(finaltime)
        basefname = 'DiamondNoNonlinear_1200time_mixedlags_d005_lowinits_' 
        lags = [100,100,115,100,57,63,32,115]
    else:
        eqns,names,ts = newDiamondTS(finaltime)
